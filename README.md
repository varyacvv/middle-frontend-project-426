...
[![hexlet-check](https://github.com/varyacvv/middle-frontend-project-426/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/varyacvv/middle-frontend-project-426/actions)
...
```bash
git clone https://github.com/varyacvv/middle-frontend-project-426.git
